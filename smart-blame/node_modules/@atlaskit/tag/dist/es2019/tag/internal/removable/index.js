...
const RemovableTagComponent = /*#__PURE__*/forwardRef(({
  ...
  const hoverCloseButtonColors = {
    ...
    [backgroundHoverCssVar]: fg('platform-component-visual-refresh') ? undefined : removalHoverBackgroundColors,
    // Tag background color on press
    [backgroundActiveCssVar]: fg('platform-component-visual-refresh') ? undefined : removalActiveBackgroundColors,
  ...
  return /*#__PURE__*/React.createElement(ExitingPersistence, null, !(status === TagStatus.Removed) && /*#__PURE__*/React.createElement(ShrinkOut, null, motion => {
