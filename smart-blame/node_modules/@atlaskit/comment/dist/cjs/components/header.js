...
var Header = function Header(_ref) {
  ...
  return shouldRender ? /*#__PURE__*/React.createElement(Heading, {
    className: (0, _runtime.ax)([headingStyles.root])
  }, /*#__PURE__*/React.createElement(_compiled.Inline, {
    alignBlock: "center",
    testId: testId,
    space: "space.100",
    as: "span",
    shouldWrap: (0, _platformFeatureFlags.fg)('platform-comment-header-wrap') && shouldHeaderWrap
  }, author, type && /*#__PURE__*/React.createElement(_lozenge.default, {
    testId: testId && "".concat(testId, "-type")
  }, type), time && !isSaving && !isError && time, edited || null, isSaving ? savingText : null, restrictedTo && /*#__PURE__*/React.createElement(_compiled.Text, {
    color: "color.text.subtlest"
  }, /*#__PURE__*/React.createElement(_compiled.Inline, {
    alignBlock: "center",
    space: "space.050",
    as: "span"
  }, "\u2022", (0, _platformFeatureFlags.fg)('platform-visual-refresh-icons-legacy-facade') || (0, _platformFeatureFlags.fg)('platform-visual-refresh-icons') ? /*#__PURE__*/React.createElement(_compiled.Box, {
    as: "span",
    ...
    label: "",
    size: "small"
  })) : /*#__PURE__*/React.createElement(_lockFilled.default, {
    size: "small",
    label: ""
  }), restrictedTo)))) : null;
};
